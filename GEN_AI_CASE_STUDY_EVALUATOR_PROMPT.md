...
1. Do NOT proceed with detailed scoring
2. Return the submission with a clear note specifying:
...
**Note**: If the submission is present but weak, still score it. If the submission is missing, assign 0 marks and explain clearly.
...
|---|---|---|---|---|---|---|---|---|
| Yes/No | 1-10 | 1-10 | 1-10 | 1-10 | 1-10 | 1-10 | X/10 | Brief summary |
...
[Comprehensive verdict based on all evaluation dimensions]
...
**Purpose:** Standardized evaluation framework for GenAI Case Study submissions
